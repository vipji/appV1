                    ...
                    {[...graduates, ...graduates].map((graduate, index) => (
                      <div key={`col1-${index}`} className="graduate-card w-full max-w-[140px] flex flex-col items-center gap-y-4 py-3 px-2 rounded-xl transition-all duration-300 hover:bg-slate-500/10 shadow-lg">
                        ...
                        <div className="flex flex-col gap-y-1 justify-center items-center text-center">
                          <p className="text-xs font-medium text-white leading-tight">{graduate.name}</p>
                          <p className="text-xs font-semibold text-yellow-400 leading-tight">{graduate.company}</p>
                          <p className="text-xs font-normal text-gray-300 leading-tight">{graduate.role}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                  {/* Gradient overlays */}
                  <div className="absolute top-0 w-full h-[120px] rounded-xl z-10 bg-gradient-to-b from-black via-black/70 to-transparent"></div>
                  <div className="absolute bottom-0 w-full h-[120px] rounded-xl z-10 bg-gradient-to-t from-black via-black/70 to-transparent"></div>
                </div>
              ...
              <div className="w-full flex flex-col items-start gap-10 flex-1">
                <div className="flex flex-col gap-y-4 self-stretch items-start">
                  <div className="flex flex-col items-start self-stretch gap-y-3">
                    <p className="text-yellow-500 font-semibold text-lg">Success Stories</p>
                    <h2 className="text-white font-bold text-3xl lg:text-4xl leading-tight">
                      ConnoisseurCode Graduates: Powering Top Tech Giants
                    </h2>
                  </div>
                  <p className="text-base text-gray-300 font-medium leading-relaxed max-w-2xl">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-4xl">
                  {achievements.map((achievement, index) => (
                    <div key={index} className="achievement-card text-center rounded-xl p-5 transition-all duration-300 hover:scale-105">
                      <div className="bg-gradient-to-br from-yellow-400 to-yellow-600 w-10 h-10 rounded-lg flex items-center justify-center mx-auto mb-3 shadow-lg">
                        <achievement.icon className="w-5 h-5 text-white" />
                      </div>
                      <div className="text-xl lg:text-2xl font-bold text-white mb-1">{achievement.value}</div>
                      <div className="text-sm font-semibold text-yellow-300 mb-1">{achievement.label}</div>
                      <div className="text-gray-400 text-xs leading-relaxed">{achievement.description}</div>
                    </div>
                  ))}
                </div>
              </div>
